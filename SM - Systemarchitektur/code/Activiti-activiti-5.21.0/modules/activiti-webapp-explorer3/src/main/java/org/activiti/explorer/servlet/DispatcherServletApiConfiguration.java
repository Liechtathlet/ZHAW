...
@EnableAsync
public class DispatcherServletApiConfiguration extends WebMvcConfigurationSupport {

  private final Logger log = LoggerFactory.getLogger(DispatcherServletApiConfiguration.class);
