...
In diesem Kapitel wird der Ablauf der computerforensischen Analyse im Detail aufgezeigt und erklärt. Die Techniken und Tools zur Unterstützung dieses Prozesses werden im Kapitel \ref{chap:ToolsTechniques} \nameref{chap:ToolsTechniques} erläutert.
...
\footnotetext[1]{Ein Writeblocker ist entweder ein physisches Gerät oder ein Stück Software welches verhindert, dass Daten auf einen Datenträger geschrieben werden können.}
...
%--------------------------------------------------
\subsection{Report (Dokumentation)}
