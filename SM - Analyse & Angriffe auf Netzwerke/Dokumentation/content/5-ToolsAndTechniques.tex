...
\subsection{Sicherung des Arbeitsspeicher-Inhaltes ohne Zugriff auf das Betriebssystem} \todo{Evtl. weitere Details und Beispiele}
...
\subsubsection{Tools} \todo{Details}
...
\subsubsection{Weitere Tools} \todo{Weitere}
...
\todo{Dateisysteme mit FileSlack, Drive-Slack, etc.}
%http://www.florianwoerter.at/publications/fileslack.pdf
...
\todo{Detail swap? Linux wie Binärdatei?}
...
\todo{Vervollständigen mit Bild CF: Seite 141}
...
\subsubsection{chkrootkit} \todo{Mehr Infos}
\begin{lstlisting}
> chkrootkit
\end{lstlisting}
...
\textbf{Konvertierung von E01 nach vmdk}\\
\begin{lstlisting}
