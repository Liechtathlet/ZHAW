...
public class DemoDataConfiguration {
  ...
  protected void initDemoGroups() {
    String[] assignmentGroups = new String[] {"security", "living", "maintenance", "cooking", "house"};
  ...
  protected void initDemoUsers() {
    createUser("openhab", "OpenHab", "", "raspberry", "", 
            null,Arrays.asList("house"),
            null);
    createUser("dani", "Dani", "", "raspberry", "", 
            null,Arrays.asList("security","living","maintenance","cooking"),
            null);
	    
    createUser("kermit", "Kermit", "The Frog", "kermit", "kermit@activiti.org", 
            "org/activiti/explorer/images/kermit.jpg",
            Arrays.asList("security","living","maintenance","cooking","house", "user", "admin"),
