...
Nachfolgend werden einige Frameworks, beziehungsweise Produkte aufgezeigt und Stichwortartig beschrieben, welche im Bereich \gls{acr:IOT} für die Realisierung und Automatisierung von Business Prozessen verwendet werden können.

\begin{itemize}

\itemBfText{\hyperlink{http://wso2.com/products/iot-server/}{WSO2 IoT Server}}{WO2 Middleware Plattform, Modular, Erweiterbar, Analytics, BPM-Support, Enterprise Service Bus}

\itemBfText{\hyperlink{https://www.pega.com/products/pega-7-platform/case-management}{Pega}}{Intelligente Business Process Management Suite}

\itemBfText{\hyperlink{http://www.softwareag.com/corporate/solutions/iot/default.asp}{Digital Business Platform}}{Analytics, Data-Management, Prozess-Automatisierung, Regeln, Tasks, B2B-Integration}

\itemBfText{\hyperlink{https://github.com/OpenIotOrg/openiot}{OpenIoT}}{Open Source, Blueprint Middlewar für IoT-Lösungen}

\itemBfText{\hyperlink{https://www.oracle.com/de/solutions/internet-of-things/index.html}{Internet of Things Cloud Service}}{Analytics, Enterprise Integration, Secure Connectivity, Echtzeitverarbeitung}

\itemBfText{\hyperlink{http://www.ritc.io/}{Ritc}}{Software as a Service Plattform für IoT, Rule-Engine für Datenverarbeitung}

\itemBfText{\hyperlink{https://flowthings.io/}{Flowthings}}{Plattform für IoT Lösungen, Cloud basiert, Echtzeit Verarbeitung, Komplexe Eventverarbeitung}

\itemBfText{\hyperlink{http://ubidots.com/}{ubidots}}{Cloud-Service, Analyse, Aggregierung und Visualisierung von Sensordaten, Definition Regeln und Aktionen}

\itemBfText{\hyperlink{http://www.zettajs.org/}{zetta}}{API-Frist IoT Plattform, basierend auf Node.js, Open Source}

\itemBfText{\hyperlink{http://www.waylay.io/}{Waylay}}{Plattform für die Orchestrierung von Enterprise IoT, Analytics, Monitoring, Auslöser und Aktionen}

\itemBfText{\hyperlink{http://litmusautomation.com/}{Loop (Litmus Automation)}}{IoT Cloud Plattform, High Perfromance und Skalierbarkeit}

\itemBfText{\hyperlink{https://www.octoblu.com/}{Octoblu}}{Full-STack IoT Plattform, Messaging, Automatisierung, Echtzeitverarbeitung}
\end{itemize}
